package com.moin.smartcar.Custom;

/**
 * Created by macpro on 1/11/16.
 */
...
//                    DEFAULT_ANIMATION_DURATION);
    ...
    public void setFab(ImageView imageView,int my_x,int my_y) {
        my_cx = my_x;
        my_cy = my_y;
        mFab = imageView;
    }
...
//        int cy = fab1.getTop();
//
//        int cx1 = fab1.getRight();
//        int cy1 = fab1.getBottom();
//
//        int x = (int) (cx1 - cx);
//        int y = (int) (cy1 - cy);
